...
const About = () => {
    ...
    return (<div id="floor1" className="flex flex-col gap-8 h-screen items-center justify-center overflow-hidden pt-24 sm:pt-0">
        <motion.div
            initial={{ opacity: 0 }}
            whileInView={{
                opacity: 1,
            ...
            <Image alt="" className="object-cover rounded-md shadow-md" height={540} width={1080} src={`/assets/about/about.jpg`} />
        ...
        <div className="flex flex-col gap-2 sm:gap-3 md:gap-4 text-center w-screen lg:w-[1024px] px-8 lg:px-0">
            <motion.h1
